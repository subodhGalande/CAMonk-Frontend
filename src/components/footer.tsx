...
const Footer = ({
  ...
  copyright = "© 2025 CA MONK. All rights reserved.",
  bottomLinks = [
  ...
  return (
    <section
      className={cn(
        "py-10 px-10 max-w-[1440px] bg-foreground mx-auto",
        className
      )}
    >
      <div className="container">
        <footer>
          ...
          <div className="mt-10 flex flex-col justify-between gap-4 border-t border-muted-foreground pt-8 text-sm font-medium text-muted-foreground md:flex-row md:items-center">
            <p>{copyright}</p>
